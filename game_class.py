...
class game:
  ...
  def __init__(self):
    # Initialize levels
    self.level_1 = level_class.Level(settings.maps.level_1_map, self)
    self.level_2 = level_class.Level(settings.maps.level_2_map, self)
    self.level_3 = level_class.Level(settings.maps.level_3_map, self)
    self.level_4 = level_class.Level(settings.maps.level_4_map, self)
    self.level_5 = level_class.Level(settings.maps.level_5_map, self)
    self.level_6 = level_class.Level(settings.maps.level_6_map, self)
    self.level_7 = level_class.Level(settings.maps.level_7_map, self)
    self.level_8 = level_class.Level(settings.maps.level_8_map, self)
