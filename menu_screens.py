...
import pygame
# Start screen
start_button = button_class.Button(button_font, "START", "white", "green", (SCREEN_W//2, SCREEN_H//2), (150,150), 5, start_button_group)
start_button.fit_to_text()
start_button.rect.center = (SCREEN_W//2, SCREEN_H//2)

# Class select
knight_button = button_class.Button(button_font, "KNIGHT", "white", "red4", (SCREEN_W//4, SCREEN_H//3), (150,150), 5, class_button_group)
knight_button.fit_to_text()

archer_button = button_class.Button(button_font, "ARCHER", "white", "green4", (2*SCREEN_W//4, SCREEN_H//3), (150,150), 5, class_button_group)
archer_button.fit_to_text()


mage_button = button_class.Button(button_font, "MAGE", "white", "blue4", (3*SCREEN_W//4, SCREEN_H//3), (150,150), 5, class_button_group)
...
# Pause screen
resume_button = button_class.Button(button_font, "RESUME", "white", "green", (SCREEN_W//2, SCREEN_H//3), (150,150), 5, pause_button_group)
resume_button.fit_to_text()
resume_button.rect.center = (SCREEN_W//2, SCREEN_H//3)

quit_button = button_class.Button(button_font, "QUIT", "white", "red", (SCREEN_W//2, 2*SCREEN_H//3), (150,150), 5, pause_button_group)
